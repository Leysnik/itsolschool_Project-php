	...
	<section id="propt" datset="<?php echo $all; ?>" class="flex-container">
			...
			<div class="flex-container-2">
				<div class="flex-container row">
					<div class="flex-container">
						...
						<label>Имя</label>
						<input type="text" name="name" class="text-field_prof" value="<?php echo $name;?>"> </div>
					<div class="flex-container">
						<label>Фамилия</label>
						<input type="text" name="surname" class="text-field_prof" value="<?php echo $surname;?>"> </div>
					<div class="flex-container">
						<label>Отчество(при наличии)</label>
						<input type="text" name="lastname" class="text-field_prof" value="<?php echo $lastname;?>"> </div>
				</div>
				<div class="flex-container row">
					...
					<div class="flex-container">
						...
						<div>
							...
							<input type="number" name="birth_max" class="text-field_prof number" value="<?php echo $birth_max;?>" placeholder="max" min="16" max="100"> </div>
					</div>
					<div class="flex-container">
						<label>Город</label>
						<input type="text" name="city" class="text-field_prof" value="<?php echo $city;?>"> </div>
				</div>
				<div class="flex-container row">
					<div class="flex-container">
        ...
        ?>
				...
				<div class="flex-container row">
					<div class="flex-container">
						<label>Телефон</label>
						<input type="tel" name="tel" id="tel" class="text-field_prof" value="<?php echo $tel;?>"> </div>
					<div class="flex-container">
						<label>Email</label>
						<input type="email" id="email" name="email" class="text-field_prof" value="<?php echo $email;?>"> </div>
				</div>
			</div>
			<br>
			<div class="flex-container-2">
				<div class="flex-container">
					<label>VK</label>
					<input type="text" name="vk" class="text-field_prof" value="<?php echo $vk;?>"> </div>
				<div class="flex-container">
					<label>INSTAGRAM</label>
					<input type="text" name="instagram" class="text-field_prof" value="<?php echo $instagram;?>"> </div>
				<div class="flex-container">
					<label>HeadHunter</label>
					<input type="text" name="social" class="text-field_prof" value="<?php echo $social;?>"> </div>
			</div>
			<div class="flex-container-2 pinned-container">
				<label class="pinned" for="pinned">Избранное</label>
				<input id="pinned" type="checkbox" name="pinned" value="1" <?php if($pinned==1 ){echo 'checked';}?>> </div>
			<div class="flex-container-2">
				<input id="create" type="submit" class="alter-butt butt " value="Поиск"> </div>
