			...
			<div class="flex-container-2">
				<div class="flex-container row">
					<div class="flex-container">
						...
						<input type="text" name="name" class="text-field_prof" value="" required> </div>
					<div class="flex-container">
						<label>Фамилия<span class="red">*</span></label>
						<input type="text" name="surname" class="text-field_prof" value="" required> </div>
					<div class="flex-container">
						<label>Отчество(при наличии)</label>
						<input type="text" name="lastname" class="text-field_prof" value=""> </div>
				</div>
				<div class="flex-container row">
					...
					<div class="flex-container">
						...
						<input type="date" name="birth" class="text-field_prof" value="" min="<?php print_r(date('Y')-100);?>-01-01" max="<?php print_r(date('Y')-16);?>-01-01" required> </div>
					<div class="flex-container">
						<label>Город<span class="red">*</span></label>
						<input type="text" name="city" class="text-field_prof" value="" required> </div>
				</div>
				<div class="flex-container row">
					<div class="flex-container">
						<label>Образование<span class="red">*</span></label>
						<textarea name="educatePlace" class="textarea text-field_prof" value="" required> </textarea>
					</div>
					<div class="flex-container">
        ...
        ?>
				...
				<div class="flex-container row">
					<div class="flex-container correct-t ">
						...
						<input type="date" id="meetday" name="meetday" class="date" value="" min="<?php print_r(date('Y')-20);?>-01-01" max="<?php print_r(date('Y-m-d'));?>" required> </div>
					<div class="flex-container correct-t ">
						<label>Дата стажировки</label>
						<input type="date" id="testtime" name="testtime" class="date" value="" min="<?php print_r(date('Y')-20);?>-01-01" max="<?php print_r(date('Y-m-d'));?>"> </div>
					<div class="flex-container correct-t ">
						<label>Дата размещения вакансии<span class="red">*</span></label>
						<input type="date" id="datevacantion" name="datevacantion" class="date" value="" min="<?php print_r(date('Y')-20);?>-01-01" max="<?php print_r(date('Y-m-d'));?>" required> </div>
				</div>
			</div>
			<br>
			<div class="flex-container-2">
			...
			<div class="flex-container send">
				<div class="send-container">
					...
					<br>
					<input id="resume" type="file" name="resume" class="send-field_prof" onchange="Filevalidation()" value="" required> <img src="../../img/Feedbin-Icon-check.svg.png" alt="" class="disable d-img"> </div>
				<div class="send-container">
					<label for="testpdf" class="file-create">Тестовое задание<span class="red">*</span></label>
					<br>
					<input id="testpdf" type="file" name="testpdf" class="send-field_prof" value="" onchange="Filevalidation()" required> <img src="../../img/Feedbin-Icon-check.svg.png" alt="" class="disable d-img"> </div>
			</div>
			<div class="flex-container">
			...
			<div class="position-r-2">
				...
				<input id="pinned" type="checkbox" name="pinned" value="1"> </div>
			<div class="position-r">
				<input id="next" type="button" class="alter-butt butt" value="Дальше">
				<input id="create" type="submit" class="alter-butt butt disable" value="Создать"> </div>
		</form>
</section>